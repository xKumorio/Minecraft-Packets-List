# Minecraft 1.21.6 Packet IDs - Java Edition Protocol Reference

Every known clientbound and serverbound packet ID for Minecraft Java Edition **1.21.6**, with packet fields and descriptions where available.

[← Back to the full packet reference](../README.md)

## Clientbound Packets (134)
...
| [TRACKED_WAYPOINT](#tracked_waypoint) | 0x83 | 131 |
| [CLEAR_DIALOG](#clear_dialog) | 0x84 | 132 |
| [SHOW_DIALOG](#show_dialog) | 0x85 | 133 |
