...
- [Clientbound Packets](#clientbound) - 173 packets
- [Serverbound Packets](#serverbound) - 74 packets

---

## Clientbound Packets

**Clientbound packets** are sent from server to client. Total: **173 packets**.
...
**Serverbound packets** are sent from client to server. Total: **74 packets**.
...
This packet is sent from the client to the server when the client attacks another entity (a player, minecart, etc). A vanilla server only accepts this packet if the entity being attacked is visible without obstruction and within a 4-unit radius of the player's position.

**Packet Fields:**

| Type | Description |
| --- | --- |
| `VAR_INT` | Entity ID: The ID of the attacked entity. Note the special case of the ender dragon described on the Interact packet. |
| `VAR_INT` | Entity ID: The ID of the attacked entity. Note the special case of the ender dragon described on the Interact packet. |
...
| Type | Description |
| --- | --- |
| `VAR_INT` | Hand to Swing, 0 = Main Hand |
...
| [GAME_RULE_VALUES](#game_rule_values) | [26.1](./versions/26.1.md) | 0x27 | 39 |
| [LOW_DISK_SPACE_WARNING](#low_disk_space_warning) | [26.1](./versions/26.1.md) | 0x32 | 50 |
...
| [ATTACK](#attack) | [26.1](./versions/26.1.md) | 0x1 | 1 |
| [SET_GAME_RULE](#set_game_rule) | [26.1](./versions/26.1.md) | 0x39 | 57 |
| [SPECTATE_ENTITY](#spectate_entity) | [26.1](./versions/26.1.md) | 0x3E | 62 |
...
*Last updated: 2026-07-11 23:26:31 UTC*
