...
This comprehensive database contains packet IDs for Minecraft protocol packets including clientbound and serverbound packets. Find packet IDs, version ranges, packet fields, and detailed descriptions for all Minecraft versions from 1.8 to latest — including a dedicated page per version and a list of packets exclusive to a single version.

## 📋 Quick Navigation

- [What are Minecraft Packets?](#what-are-minecraft-packets)
- [How to Use This Reference](#how-to-use-this-reference)
- [Browse by Version](#browse-by-version)
- [Packet Lists](#packet-lists)
- [Packets Exclusive to a Single Version](#packets-exclusive-to-a-single-version)
...
5. Need the full packet list for one specific version instead? Open [`versions/<version>.md`](./versions/README.md) — e.g. `versions/1.21.5.md`
6. Looking for packets that only exist in a single version? See [Packets Exclusive to a Single Version](#packets-exclusive-to-a-single-version)
...
Looking for the packet list of one specific Minecraft version instead? Each version below has its own page listing every packet ID valid for it — see the [versions index](./versions/README.md) or jump straight to a version:

[1.8](./versions/1.8.md), [1.9](./versions/1.9.md), [1.9.3](./versions/1.9.3.md), [1.12](./versions/1.12.md), [1.12.1](./versions/1.12.1.md), [1.13](./versions/1.13.md), [1.14](./versions/1.14.md), [1.14.4](./versions/1.14.4.md), [1.15](./versions/1.15.md), [1.16](./versions/1.16.md), [1.16.2](./versions/1.16.2.md), [1.17](./versions/1.17.md), [1.17.1](./versions/1.17.1.md), [1.18](./versions/1.18.md), [1.19](./versions/1.19.md), [1.19.1](./versions/1.19.1.md), [1.19.3](./versions/1.19.3.md), [1.19.4](./versions/1.19.4.md), [1.20.2](./versions/1.20.2.md), [1.20.3](./versions/1.20.3.md), [1.20.5](./versions/1.20.5.md), [1.21](./versions/1.21.md), [1.21.2](./versions/1.21.2.md), [1.21.4](./versions/1.21.4.md), [1.21.5](./versions/1.21.5.md), [1.21.6](./versions/1.21.6.md), [1.21.9](./versions/1.21.9.md), [1.21.11](./versions/1.21.11.md)
...
## Packets Exclusive to a Single Version

These packets only ever appear in exactly one recorded protocol snapshot — either a short-lived packet added and reworked again within the same version, or a very recent addition not yet carried forward. Check the [version page](./versions/README.md) for that release to see its full packet list.

### Clientbound

| Packet | Version | ID (hex) | ID (dec) |
| --- | --- | --- | --- |
| [MAP_BULK_CHUNK](#map_bulk_chunk) | [1.8](./versions/1.8.md) | 0x26 | 38 |
| [SET_COMPRESSION](#set_compression) | [1.8](./versions/1.8.md) | 0x46 | 70 |
| [UPDATE_ENTITY_NBT](#update_entity_nbt) | [1.8](./versions/1.8.md) | 0x49 | 73 |
| [REMOVE_ENTITY](#remove_entity) | [1.17](./versions/1.17.md) | 0x3A | 58 |
| [PLAYER_CHAT_HEADER](#player_chat_header) | [1.19.1](./versions/1.19.1.md) | 0x32 | 50 |
| [MOUNT_SCREEN_OPEN](#mount_screen_open) | [1.21.11](./versions/1.21.11.md) | 0x28 | 40 |

### Serverbound

| Packet | Version | ID (hex) | ID (dec) |
| --- | --- | --- | --- |
| [CRAFTING_RECIPE_PLACEMENT](#crafting_recipe_placement) | [1.12](./versions/1.12.md) | 0x1 | 1 |
| [CHANGE_GAME_MODE](#change_game_mode) | [1.21.6](./versions/1.21.6.md) | 0x4 | 4 |
| [CUSTOM_CLICK_ACTION](#custom_click_action) | [1.21.6](./versions/1.21.6.md) | 0x41 | 65 |
...
### Where do I find packets that only exist on one specific Minecraft version?

See the [Packets Exclusive to a Single Version](#packets-exclusive-to-a-single-version) section above — it lists every packet that only ever appears in one recorded protocol snapshot. For the complete packet list of any single version (not just the exclusive ones), open its page under [`versions/`](./versions/README.md), e.g. [`versions/1.21.11.md`](./versions/1.21.11.md).
...
Minecraft packet ID, Minecraft protocol, packet reference, clientbound packets, serverbound packets, Minecraft version compatibility, protocol version, packet IDs by version, Minecraft Java Edition protocol, network protocol packets, packet fields, packet ID by Minecraft version, version-exclusive packets, Minecraft packet database

---

*Last updated: 2026-07-11 23:14:03 UTC*
